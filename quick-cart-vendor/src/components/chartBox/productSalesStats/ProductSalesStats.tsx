  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        const totalProducts = filteredOrders.reduce((acc: number, order: any) => {
          return (
            acc +
        ...
        const currentMonthProducts = filteredOrders.reduce((acc: number, order: any) => {
        ...
        const lastMonthProducts = filteredOrders.reduce((acc: number, order: any) => {
        ...
        const monthlyProductSales = Array.from({ length: 12 }, (_, i) => {
          const monthProducts = filteredOrders.reduce((acc: number, order: any) => {
